...
@WebServlet(name = "IterationZwei", value = "/IterationZwei")
public class IterationZwei extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<title>Iteration 2</title></head>");
        out.println("<body>");
        out.println("<div class=\"card\" style=\"width: 18rem; margin: 0 auto; margin-top: 20px;\">");
        out.println("<div class=\"card-body\">");
        out.println("<h5 class=\"card-title\">Iteration 2</h5>");
        if(remainingNum == -1) {
        ...
        out.println("<form name=\"form\" action=\"IterationZwei\" method=\"POST\">");
